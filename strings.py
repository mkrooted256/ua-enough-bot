...
special_ans = dict(
    ANS_TOO_BUSY= \
"""Дуже круто, що ви допомагаєте! Тільки, будь ласка, не забувайте про себе та про свої потреби.
...
Отож, має сенс до нього дожити :)""", 
    ...
    ANS_TOO_LARGE_DONATION= \
"""Розмір ваших пожертв вражає! Сподіваємося, що ви хоч іноді купуєте щось для себе, для душі.""", 
